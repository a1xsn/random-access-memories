  ...
  return (
    <Section ref={ref} id="faq">
      ...
      <Container>
        ...
        To participate in Bilita Mpash, you need a Totem - ERC-1155 collectible NFT on Polygon, with 5 different editions. To reveal The Totem, write a DM on our Twitter account to get a Key. During the reveal, you will receive a link to enter The Island using the 8XR application. It's available across many browsers and devices, but at first make sure to register on 8XR platform connect your Metamask wallet that holds The Totem. In case you get lost, DM us on Twitter for all the details.
        </Accordion>
