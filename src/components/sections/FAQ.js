  ...
  return (
    <Section ref={ref} id="faq">
      ...
      <Container>
        ...
        To participate in Bilita Mpash, mint The Totem - it's an ERC-1155 collectible NFT on Polygon, with 5 different editions. After you mint The Totem, you will receive a link to enter The Island using the 8XR application. It's available across many browsers and devices, but make sure to connect the wallet that holds The Totem when you enter. In case you get lost, check out our Discord for all the details.
        </Accordion>
